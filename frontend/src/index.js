  ...
  <Provider store={store}>
    <Router history={history}>
      <Switch>
        ...
        <Route path={path + LOGIN_PAGE} exact component={LoginPage}/>
        <Route path={path + REGISTRATION_PAGE} exact component={RegisterPage}/>
        <Route path={path + MAIN_PAGE} exact component={MainPage}/>
